...
class Child_Status_Model(QWidget):
    ...
    def __init__(self, parent=None, co=None):
        ...
        # Children (5-17 years)
        self.goto_school_button = QPushButton(
            'Child goes to\nschool on\ntravel day', self)
        self.goto_school_button.setGeometry(
            (size.width()) / 2 - 100, size.height() / 2 - 460, 120, 75)
        self.goto_school_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHDAILYSTATUS))
        self.connect(
            self.goto_school_button, SIGNAL('clicked()'), self.goto_school)

        self.independent_to_school_button = QPushButton(
            'Child travels to\nschool\nindependently', self)
        self.independent_to_school_button.setGeometry(
            (size.width()) / 2 - 100, size.height() / 2 - 360, 120, 75)
        self.independent_to_school_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHDAILYINDEP))
        self.connect(self.independent_to_school_button, SIGNAL(
            'clicked()'), self.travel_independently_to_school)
...
#         self.connect(self.activity_with_adult_button, SIGNAL('clicked()'), self.activity_with_adult)
        ...
        self.in_activity_independently_button = QPushButton(
            'Child is\nindependent', self)
        self.in_activity_independently_button.setGeometry(
            (size.width()) / 2 - 340, size.height() / 2 - 460, 120, 75)
        self.in_activity_independently_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_HMINDEP))
        self.connect(self.in_activity_independently_button, SIGNAL(
            'clicked()'), self.child_independent)
...
# self.connect(pick_up_school_button, SIGNAL('clicked()'), self.pick_up_event)
        ...
        self.goto_preschool_button0.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 420, 120, 20)
        self.goto_preschool_button0.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHSTATUSAGE0))
        self.connect(self.goto_preschool_button0, SIGNAL(
            'clicked()'), self.goto_preschool0)

        self.goto_preschool_button1 = QPushButton('1 Year Old', self)
        self.goto_preschool_button1.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 395, 120, 20)
        self.goto_preschool_button1.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHSTATUSAGE1))
        self.connect(self.goto_preschool_button1, SIGNAL(
            'clicked()'), self.goto_preschool1)

        self.goto_preschool_button2 = QPushButton('2 Years Old', self)
        self.goto_preschool_button2.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 370, 120, 20)
        self.goto_preschool_button2.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHSTATUSAGE2))
        self.connect(self.goto_preschool_button2, SIGNAL(
            'clicked()'), self.goto_preschool2)

        self.goto_preschool_button3 = QPushButton('3 Years Old', self)
        self.goto_preschool_button3.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 345, 120, 20)
        self.goto_preschool_button3.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHSTATUSAGE3))
        self.connect(self.goto_preschool_button3, SIGNAL(
            'clicked()'), self.goto_preschool3)

        self.goto_preschool_button4 = QPushButton('4 Years Old', self)
        self.goto_preschool_button4.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 320, 120, 20)
        self.goto_preschool_button4.setStyleSheet(
            self.color.isUserModel(MODELKEY_SCHSTATUSAGE4))
        self.connect(self.goto_preschool_button4, SIGNAL(
            'clicked()'), self.goto_preschool4)

        # Work Status
        self.work_status1_button = QPushButton(
            'Adult Work Status -\nfirst episode', self)
        self.work_status1_button.setGeometry(
            (size.width()) / 2 + 395, size.height() / 2 - 100, 180, 50)
        self.work_status1_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_WRKSTATUSADL1))
        self.connect(
            self.work_status1_button, SIGNAL('clicked()'), self.work_status1)

        self.work_status2_button = QPushButton(
            'Adult Work Status -\nsecond episode', self)
        self.work_status2_button.setGeometry(
            (size.width()) / 2 + 395, size.height() / 2 - 20, 180, 50)
        self.work_status2_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_WRKSTATUSADL2))
        self.connect(
            self.work_status2_button, SIGNAL('clicked()'), self.work_status2)

        self.nonadult_work_status_button = QPushButton(
            'Non-Adult Work Status', self)
        self.nonadult_work_status_button.setGeometry(
            (size.width()) / 2 + 395, size.height() / 2 + 60, 180, 50)
        self.nonadult_work_status_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_WRKSTATUSNON))
        self.connect(self.nonadult_work_status_button, SIGNAL(
            'clicked()'), self.nonadult_work)
    ...
    def independently_after_school(self):
        ...
        self.independent_from_school_button.setStyleSheet(
            self.color.isUserModel(modelkey))
    ...
    def activity_type_nonwrkr(self):
        ...
        self.activity_type_button.setStyleSheet(
            self.color.isUserModel(modelkey))
    ...
    def activity_with_adult(self):
        ...
        self.activity_with_adult_button.setStyleSheet(
            self.color.isUserModel(modelkey))
    ...
    def paintEvent(self, parent=None):
        ...
        # Children (5-17 years)
        line.drawLine(widgetwidth / 2 - 40, widgetheight / 2 -
                      520, widgetwidth / 2 - 40, widgetheight / 2 + 0)
        line.drawLine(widgetwidth / 2 - 280, widgetheight / 2 -
                      400, widgetwidth / 2 - 280, widgetheight / 2 - 270)
        #line.drawLine(widgetwidth / 2 - 280, widgetheight / 2 - 3, widgetwidth / 2 - 280, widgetheight / 2 + 67)

        line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 -
                      423, widgetwidth / 2 - 90, widgetheight / 2 - 423)
        # line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 - 98, widgetwidth / 2 - 90, widgetheight / 2 - 98)
        line.drawLine(widgetwidth / 2 - 170, widgetheight / 2 -
                      110, widgetwidth / 2 - 90, widgetheight / 2 - 110)
        #line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 + 3, widgetwidth / 2 - 90, widgetheight / 2 + 3)

        line.drawLine(widgetwidth / 2 - 330, widgetheight / 2 -
                      423, widgetwidth / 2 - 400, widgetheight / 2 - 423)
        line.drawLine(widgetwidth / 2 - 400, widgetheight / 2 -
                      423, widgetwidth / 2 - 400, widgetheight / 2 - 350)
...
#         line.drawLine(widgetwidth / 2 - 350, widgetheight / 2 - 98, widgetwidth / 2 - 400, widgetheight / 2 - 98)
        ...
        line.drawLine(widgetwidth / 2 - 90, widgetheight / 2 -
                      323, widgetwidth / 2 - 170, widgetheight / 2 - 323)
        line.drawLine(widgetwidth / 2 - 170, widgetheight / 2 -
                      323, widgetwidth / 2 - 170, widgetheight / 2 - 110)
...
#         line.drawLine(widgetwidth / 2 + 30, widgetheight / 2 + 435, widgetwidth / 2 + 90, widgetheight / 2 + 435)
        ...
        # Pre-school Children
        line.drawLine(widgetwidth / 2 + 220, widgetheight / 2 -
                      520, widgetwidth / 2 + 220, widgetheight / 2 - 175)
        line.drawLine(widgetwidth / 2 + 270, widgetheight / 2 -
                      363, widgetwidth / 2 + 370, widgetheight / 2 - 363)

        # Work Statue
        line.drawLine(widgetwidth / 2 + 352, widgetheight / 2 -
                      75, widgetwidth / 2 + 352, widgetheight / 2 + 85)
        line.drawLine(widgetwidth / 2 + 310, widgetheight / 2 -
                      75, widgetwidth / 2 + 395, widgetheight / 2 - 75)
        line.drawLine(widgetwidth / 2 + 352, widgetheight / 2 +
                      5, widgetwidth / 2 + 395, widgetheight / 2 + 5)
        line.drawLine(widgetwidth / 2 + 352, widgetheight / 2 +
                      85, widgetwidth / 2 + 395, widgetheight / 2 + 85)
...
#         arrow.drawPolygon(QPoint(point.x(),point.y()),QPoint(point.x() - 13, point.y() - 4), QPoint(point.x() - 13, point.y() + 4))
        ...
        arrow.drawRoundedRect(
            widgetwidth / 2 - 120, widgetheight / 2 - 560, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 140, widgetheight / 2 - 560, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 130, widgetheight / 2 - 100, 180, 50, 15.0, 15.0)

        arrow.setBrush(QColor("#F0F0F0"))
        # arrow.drawRoundedRect(widgetwidth/2 - 360, widgetheight/2 + 57, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 360, widgetheight / 2 - 280, 160, 50, 15.0, 15.0)

        arrow.drawRoundedRect(
            widgetwidth / 2 - 140, widgetheight / 2 - 235, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 - 135, 120, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 140, widgetheight / 2 - 35, 200, 50, 15.0, 15.0)
        # arrow.drawRoundedRect(widgetwidth/2 - 140, widgetheight/2 + 330, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 500, widgetheight / 2 - 360, 200, 50, 15.0, 15.0)
#         arrow.drawRoundedRect(widgetwidth/2 - 360, widgetheight/2 - 123, 160, 50, 15.0, 15.0)
        ...
        arrow.drawRoundedRect(
            widgetwidth / 2 + 360, widgetheight / 2 - 388, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 130, widgetheight / 2 - 460, 180, 170, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 130, widgetheight / 2 - 255, 180, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 130, widgetheight / 2 - 175, 180, 50, 15.0, 15.0)
...
#         text.drawText(point, "No")
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Simulate activity\ntravel patterns for\nchild dynamically')

        temp = QRect(widgetwidth / 2 - 140, widgetheight / 2 - 235, 200, 50)
        text.drawText(
            temp, Qt.AlignCenter, 'Assign an adult drop-off event to\nhousehold')
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Assign an adult stay-\nhome event to household')
...
#         text.drawText(temp, Qt.AlignCenter, 'Simulate mode\nchoice dynamically')
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Child goes to pre-school\non travel day')
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Assign an adult pick-up event to \nhousehold')
