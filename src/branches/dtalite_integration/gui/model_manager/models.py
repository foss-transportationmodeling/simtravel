...
class Models(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Define a global var named "model_widget" to ues in the each function
        # as a parent widget
        global model_widget
        model_widget = parent
    ...
    def show_fixed_activity_models(self):
        self.fixed_activity_models = FixedActivityModels(
            model_widget, self.configobject)
        self.fixed_activity_models.show()

    def show_vehicle_ownership_models(self):
        self.vehicle_ownership_models = VehicleOwnershipModels(
            model_widget, self.configobject)
        self.vehicle_ownership_models.show()

    def show_fixed_activity_prism_models(self):
        self.fixed_activity_prism_models = FixedActivityPrismModels(
            model_widget, self.configobject)
        self.fixed_activity_prism_models.show()

    def show_skeleton_reconciliation_system(self):
        self.skeleton_reconciliation_system = Skeleton_Reconciliation_System(
            model_widget, self.configobject)
        self.skeleton_reconciliation_system.show()

    def show_travel_reconciliation_system(self):
        self.travel_reconciliation_system = Travel_Reconciliation_System(
            model_widget, self.configobject)
    ...
    def show_child_status_model(self):
        self.child_status_model = Child_Status_Model(
            model_widget, self.configobject)
    ...
    def show_activity_travel_pattern_simulator(self):
        self.activity_travel_pattern_simulator = Activity_Travel_Pattern_Simulator(
            model_widget, self.configobject)
