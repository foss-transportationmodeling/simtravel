...
# self.connect(drop_off_school1_button, SIGNAL('clicked()'), self.drop_off_event)
        ...
        self.independent_from_school_button = QPushButton(
            'Child\nindependent\nafter-school', self)
        self.independent_from_school_button.setGeometry(
            (size.width()) / 2 - 100, size.height() / 2 - 135, 120, 75)
        self.independent_from_school_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_AFTSCHDAILYINDEP))
        self.connect(self.independent_from_school_button, SIGNAL(
            'clicked()'), self.independently_after_school)
...
# self.connect(after_school_activity_button, SIGNAL('clicked()'), self.after_school_activity)
        ...
        self.activity_type_button = QPushButton(
            'After-school activity type choice', self)
        self.activity_type_button.setGeometry(
            (size.width()) / 2 - 140, size.height() / 2 + 90, 200, 50)
        self.activity_type_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_AFTSCHACTTYPEWRKR))
        self.connect(self.activity_type_button, SIGNAL(
            'clicked()'), self.activity_type_nonwrkr)

        self.destination_button = QPushButton(
            'After-school activity\ndestination choice', self)
        self.destination_button.setGeometry(
            (size.width()) / 2 - 140, size.height() / 2 + 170, 200, 50)
        self.destination_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_AFTSCHACTDEST))
        self.connect(
            self.destination_button, SIGNAL('clicked()'), self.activity_dest)

        self.duration_button = QPushButton(
            'After-school activity\nduration model', self)
        self.duration_button.setGeometry(
            (size.width()) / 2 - 140, size.height() / 2 + 250, 200, 50)
        self.duration_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_AFTSCHACTDUR))
        self.connect(
            self.duration_button, SIGNAL('clicked()'), self.activity_dur)
...
# self.connect(drop_off_school2_button, SIGNAL('clicked()'), self.drop_off_event)
        ...
        self.activity_with_adult_button = QPushButton(
            'Adult stays with child for\nactivity', self)
        self.activity_with_adult_button.setGeometry(
            (size.width()) / 2 - 140, size.height() / 2 + 410, 200, 50)
        self.activity_with_adult_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_AFTSCHJOINTACT))
        self.connect(self.activity_with_adult_button, SIGNAL(
            'clicked()'), self.activity_with_adult)
...
# self.connect(pick_up_school_button, SIGNAL('clicked()'), self.pick_up_event)
        ...
        # Pre-school Children
        self.goto_preschool_button = QPushButton(
            'Child goes to\npre-school on\n travel day', self)
        self.goto_preschool_button.setGeometry(
            (size.width()) / 2 + 160, size.height() / 2 - 460, 120, 75)
        self.goto_preschool_button.setStyleSheet(
            self.color.isUserModel(MODELKEY_PRESCHDAILYSTATUS))
        self.connect(
            self.goto_preschool_button, SIGNAL('clicked()'), self.goto_preschool)
...
# self.connect(pick_up_preschool_button, SIGNAL('clicked()'), self.pick_up_event)
    ...
    def paintEvent(self, parent=None):
        ...
        line.drawLine(widgetwidth / 2 - 350, widgetheight / 2 -
                      255, widgetwidth / 2 - 400, widgetheight / 2 - 255)
        line.drawLine(widgetwidth / 2 - 400, widgetheight / 2 -
                      255, widgetwidth / 2 - 400, widgetheight / 2 - 98)
        line.drawLine(widgetwidth / 2 - 350, widgetheight / 2 -
                      98, widgetwidth / 2 - 400, widgetheight / 2 - 98)
        ...
        line.drawLine(widgetwidth / 2 - 170, widgetheight / 2 -
                      323, widgetwidth / 2 - 170, widgetheight / 2 - 98)

        line.drawLine(widgetwidth / 2 - 50, widgetheight / 2 -
                      98, widgetwidth / 2 + 90, widgetheight / 2 - 98)
        line.drawLine(widgetwidth / 2 + 90, widgetheight / 2 -
                      98, widgetwidth / 2 + 90, widgetheight / 2 + 435)
        line.drawLine(widgetwidth / 2 + 30, widgetheight / 2 +
                      435, widgetwidth / 2 + 90, widgetheight / 2 + 435)

        # Pre-school Children
        line.drawLine(widgetwidth / 2 + 220, widgetheight / 2 -
                      520, widgetwidth / 2 + 220, widgetheight / 2 - 245)
        line.drawLine(widgetwidth / 2 + 270, widgetheight / 2 -
                      423, widgetwidth / 2 + 370, widgetheight / 2 - 423)
        ...
        arrow.drawRoundedRect(
            widgetwidth / 2 - 360, widgetheight / 2 + 57, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
        ...
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 - 35, 120, 75, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 140, widgetheight / 2 + 330, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 500, widgetheight / 2 - 360, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 360, widgetheight / 2 - 123, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 380, widgetheight / 2 - 23, 200, 50, 15.0, 15.0)

        arrow.drawRoundedRect(
            widgetwidth / 2 + 360, widgetheight / 2 - 448, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 + 130, widgetheight / 2 - 335, 180, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Is there time to\nengage in an\nafter school\nchild activity?')
        ...
        text.drawText(
            temp, Qt.AlignCenter, 'Simulate mode\nchoice dynamically')
