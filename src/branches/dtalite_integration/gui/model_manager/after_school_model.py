...
#        #self.connect(drop_off_school1_button, SIGNAL('clicked()'), self.drop_off_event)
        ...
        self.independent_from_school_button.setGeometry((size.width()) / 2 - 100, size.height() / 2 - 465, 120, 75)
...
#        #self.connect(after_school_activity_button, SIGNAL('clicked()'), self.after_school_activity)
        ...
        self.activity_type_button.setGeometry((size.width()) / 2 - 140, size.height() / 2 - 240, 200, 50)
        ...
        self.destination_button.setGeometry((size.width()) / 2 - 140, size.height() / 2 - 160, 200, 50)
        ...
        self.duration_button.setGeometry((size.width()) / 2 - 140, size.height() / 2 - 80, 200, 50)
...
#        #self.connect(drop_off_school2_button, SIGNAL('clicked()'), self.drop_off_event)
        ...
        self.activity_with_adult_button.setGeometry((size.width()) / 2 - 140, size.height() / 2 + 80, 200, 50)
...
#        #self.connect(pick_up_preschool_button, SIGNAL('clicked()'), self.pick_up_event)
    ...
    def paintEvent(self, parent = None):
        ...
        # Children (5-17 years)
        line.drawLine(widgetwidth / 2 - 40, widgetheight / 2 - 520, widgetwidth / 2 - 40, widgetheight / 2 + 90)
#         line.drawLine(widgetwidth / 2 - 280, widgetheight / 2 - 400, widgetwidth / 2 - 280, widgetheight / 2 - 270)
        line.drawLine(widgetwidth / 2 - 280, widgetheight / 2 - 333, widgetwidth / 2 - 280, widgetheight / 2 - 263)
        
#         line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 - 423, widgetwidth / 2 - 90, widgetheight / 2 - 423)
        line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 - 428, widgetwidth / 2 - 90, widgetheight / 2 - 428)
        line.drawLine(widgetwidth / 2 - 230, widgetheight / 2 - 327, widgetwidth / 2 - 90, widgetheight / 2 - 327)
...
#         line.drawLine(widgetwidth / 2 - 170, widgetheight / 2 - 323, widgetwidth / 2 - 170, widgetheight / 2 - 98)
        ...
        line.drawLine(widgetwidth / 2 - 50, widgetheight / 2 - 428, widgetwidth / 2 + 90, widgetheight / 2 - 428)
        line.drawLine(widgetwidth / 2 + 90, widgetheight / 2 - 428, widgetwidth / 2 + 90, widgetheight / 2 + 105)
        line.drawLine(widgetwidth / 2 + 30, widgetheight / 2 + 105, widgetwidth / 2 + 90, widgetheight / 2 + 105)
...
#         arrow.drawRoundedRect(widgetwidth/2 + 140, widgetheight/2 - 560, 160, 50, 15.0, 15.0)
        ...
        arrow.drawRoundedRect(widgetwidth/2 - 360, widgetheight/2 - 273, 160, 50, 15.0, 15.0)
...
#         arrow.drawRoundedRect(widgetwidth/2 - 140, widgetheight/2 - 235, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/2 - 100, widgetheight/2 - 365, 120, 75, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/2 - 140, widgetheight/2 + 0, 200, 50, 15.0, 15.0)
#         arrow.drawRoundedRect(widgetwidth/2 - 500, widgetheight/2 - 360, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/2 - 360, widgetheight/2 - 453, 160, 50, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/2 - 380, widgetheight/2 - 353, 200, 50, 15.0, 15.0)
