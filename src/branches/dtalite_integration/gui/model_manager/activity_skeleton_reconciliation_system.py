...
class Skeleton_Reconciliation_System(QWidget):
    ...
    def __init__(self, parent=None, co=None):
        ...
        skeleton_reconciliation_button = QPushButton(
            'Activity \nSkeleton Reconciliation', self)
        skeleton_reconciliation_button.setGeometry(
            (size.width()) / 2 - 100, size.height() / 2 - 350, 200, 80)
        skeleton_reconciliation_button.setStyleSheet(
        ...
        person_constraints_1_button = QPushButton(
            "Within person constraints", self)
        person_constraints_1_button.setGeometry(
...
#        diag.exec_()
    ...
    def paintEvent(self, parent=None):
        ...
        line.drawLine(widgetwidth / 2, widgetheight / 2 - 270,
                      widgetwidth / 2, widgetheight / 2 - 130)
