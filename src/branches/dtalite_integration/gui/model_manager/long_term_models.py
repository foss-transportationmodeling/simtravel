...
#        diag.exec_()
    ...
    def paintEvent(self, parent=None):
        ...
        line.drawLine((widgetwidth) / 2, widgetheight / 2 - 350,
                      (widgetwidth) / 2, widgetheight / 2 + 160)
        line.end()
        # Drawing arrow
        arrow = QPainter()
        arrow.begin(self)
        ...
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 - 320, 200, 110, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 - 180, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 - 100, 200, 130, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 + 60, 200, 70, 15.0, 15.0)
        arrow.drawRoundedRect(
            widgetwidth / 2 - 100, widgetheight / 2 + 160, 200, 50, 15.0, 15.0)
