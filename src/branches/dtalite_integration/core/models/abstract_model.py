...
class TestAbstractModel(unittest.TestCase):
    ...
    def testexpectedvalue(self):
        ...
        self.assertEqual(
            self.specification.choices, expected_value_array.varnames)
        ...
        diff_values = all(
            exp(value_array_act) == exp_expected_value_array.data)
        self.assertEqual(True, diff_values)
