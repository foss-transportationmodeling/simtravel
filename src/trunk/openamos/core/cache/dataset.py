...
class DB(object):
    ...
    def create_outputCache(self, partId=None):
        ...
        self.fileh.createTable(output_grp, "schedule_allocterm_r", Schedule_R)
        self.fileh.createTable(output_grp, "schedule_joint_allocterm_r", Schedule_R)
        self.fileh.createTable(output_grp, "schedule_cleanfixedactivityschedule_r", Schedule_R)
        self.fileh.createTable(output_grp, "schedule_childrenlastprismadj_r", Schedule_R)
        ...
        self.fileh.createTable(output_grp, "schedule_joint_dailyallocrec_r", Schedule_R)
