...
class temp_class(object):
    def __init__(self):
        db_con = DataBaseConfiguration('postgres', 'postgres', '1234', 'localhost', 'postgres')
        self.db_con = db_con
...
#get the columns for the table, append a zero '0' to each column and save in a list
...
#call the method of create class to create new class and pass the column list as argument
