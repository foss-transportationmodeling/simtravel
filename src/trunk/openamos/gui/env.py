...
COMPMODEL_WRKEPISODES = 'Number of Work Episodes'
COMPMODEL_DAYSTART = 'Earliest Day Start Time'
COMPMODEL_DAYEND = 'Latest Day End Time'
COMPMODEL_WORKSTART = 'Latest Arrival Time'
COMPMODEL_WORKEND = 'Earliest Departure Time'
COMPMODEL_WORKSTART1 = 'Latest Arrival Time (Episode 1)'
COMPMODEL_WORKEND1 = 'Earliest Departure Time (Episode 1)'
...
COMPMODEL_NUMJOBS = 'Number of Jobs'           #COMPMODEL_NUMJOBS = 'Number of Jobs'
...
MODELMAP[MODELKEY_NUMVEHS] = [COMPKEY_VEHOWN,'NumVehs']
MODELMAP[MODELKEY_VEHTYPE] = [COMPKEY_VEHATTR,'VehType']
...
PERSON_TABLE_MODELS = [MODELKEY_DAYSTART,MODELKEY_DAYEND,MODELKEY_WRKEPISODES,
                                       MODELKEY_WORKSTART1,MODELKEY_WORKEND1,MODELKEY_WORKSTART2,MODELKEY_WORKEND2,]
#                                       MODELKEY_NUMSCHEPISODES,MODELKEY_SCHSTART1,MODELKEY_SCHEND1,MODELKEY_SCHSTART2,
#                                       MODELKEY_SCHEND2]
