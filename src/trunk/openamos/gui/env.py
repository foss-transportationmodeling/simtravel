...
COMPMODEL_PRESCHDAILYSTATUS = 'Pre-school (0-4 years)'  #'Preschool Daily Status'
...
MODELMAP[MODELKEY_PRESCHDAILYSTATUS] = [COMPKEY_DAILYSCHSTATUS,COMPKEY_DAILYSCHSTATUS,1]
MODELMAP[MODELKEY_SCHDAILYSTATUS] = [COMPKEY_DAILYSCHSTATUS,COMPKEY_DAILYSCHSTATUS,6]
MODELMAP[MODELKEY_HMINDEP] = [COMPKEY_CHILDDEPEND,'OtherKidsDependency']
MODELMAP[MODELKEY_SCHDAILYINDEP] = [COMPKEY_CHILDDEPEND,'OtherKidsDependency']
MODELMAP[MODELKEY_AFTSCHDAILYINDEP] = [COMPKEY_CHILDDEPEND,'OtherKidsDependency']
