...
COMPKEY_MORNWRKR = 'MorningVertexWorkers'
...
COMPMODEL_WORKSTART = 'Work Prism Start'
COMPMODEL_WORKEND = 'Work Prism End'
...
MODELKEY_WORKSTART = 'WorkStart'
MODELKEY_WORKEND = 'WorkEnd'
