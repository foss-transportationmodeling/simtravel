...
MODELMAP[MODELKEY_PRESCHDAILYSTATUS] = [COMPKEY_AFTSCHACTS,'']
MODELMAP[MODELKEY_SCHDAILYSTATUS] = [COMPKEY_AFTSCHACTS,'']
MODELMAP[MODELKEY_HMINDEP] = [COMPKEY_AFTSCHACTS,'Dependence']
MODELMAP[MODELKEY_SCHDAILYINDEP] = [COMPKEY_AFTSCHACTS,'Dependence']
MODELMAP[MODELKEY_AFTSCHDAILYINDEP] = [COMPKEY_AFTSCHACTS,'Dependence']
