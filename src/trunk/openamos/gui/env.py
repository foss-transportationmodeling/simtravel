...
MODELMAP[MODELKEY_WRKSTATUSADL1] = [COMPKEY_PERATTR,'DailyWorkStatusAdults',1]
MODELMAP[MODELKEY_WRKSTATUSADL2] = [COMPKEY_PERATTR,'DailyWorkStatusAdults',2]
...
MODELMAP[MODELKEY_AFTSCHACTTYPENONWRKR] = [COMPKEY_AFTSCHACTS,'AftSchActivityTypeNonWorkers']
MODELMAP[MODELKEY_AFTSCHACTTYPEWRKR] = [COMPKEY_AFTSCHACTS,'AftSchActivityTypeWithWork']
