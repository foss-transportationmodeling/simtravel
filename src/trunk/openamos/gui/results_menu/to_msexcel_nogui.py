...
class Export_Outputs(object):
    ...
    def quary1(self,column,nhts):
        ...
        if nhts and column == "endtime":
            ...
            temp = "(select houseid, personid, max(%s) as %s from schedule_nhts where starttime <> 0 and activitytype = 100 group by houseid, personid) as d"%(column,column)
