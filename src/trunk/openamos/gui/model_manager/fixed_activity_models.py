...
#        activity_loc_button.setGeometry((size.width()) / 4 - 100, size.height() / 2 + 110, (size.width()) / 2 + 200, 50)
    ...
    def paintEvent(self, parent = None):
        ...
        line.setPen(pen)
        line.drawLine(widgetwidth / 4, widgetheight / 2 - 350, widgetwidth / 4, widgetheight / 2 - 320)
        line.drawLine(widgetwidth / 4, widgetheight / 2 + 80, widgetwidth / 4, widgetheight / 2 + 110)
        line.drawLine(widgetwidth / 2, widgetheight / 2 - 350, widgetwidth / 2, widgetheight / 2 - 320)
        line.drawLine(widgetwidth / 2, widgetheight / 2 + 80, widgetwidth / 2, widgetheight / 2 + 110)
        line.drawLine(widgetwidth * 3 / 4, widgetheight / 2 - 350, widgetwidth * 3 / 4, widgetheight / 2 - 320)
        line.drawLine(widgetwidth * 3 / 4, widgetheight / 2 + 80, widgetwidth * 3 / 4, widgetheight / 2 + 110)
        line.end()
        # Drawing arrow
        arrow = QPainter()
        arrow.begin(self)
        ...
        arrow.drawRoundedRect(widgetwidth*3/4 - 100, widgetheight/2 - 400, 200, 50, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/4 - 100, widgetheight/2 - 320, 200, 400, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth/2 - 100, widgetheight/2 - 320, 200, 400, 15.0, 15.0)
        arrow.drawRoundedRect(widgetwidth*3/4 - 100, widgetheight/2 - 320, 200, 400, 15.0, 15.0)
        ...
        text.drawText(temp, Qt.AlignCenter, 'Students \n(Children 5-14 years)\n+ (Adults)')

        temp = QRect(widgetwidth*3/4 - 100, widgetheight/2 - 400, 200, 50)
        text.drawText(temp, Qt.AlignCenter, 'Preschoolers \n(Children 0-4 years)')

        temp = QRect(widgetwidth/4 - 100, widgetheight/2 - 320, 200, 400)
        text.drawText(temp, Qt.AlignCenter, 'Identify Primary Work Location \n\n\nSimulate Choice Sets \nWithin 90-120 mins \nTravel from Residence')

        temp = QRect(widgetwidth/2 - 100, widgetheight/2 - 320, 200, 400)
        text.drawText(temp, Qt.AlignCenter, 'School Location \n\n\nSimulate Choice Sets \nWithin 60 mins \nTravel from Residence')

        temp = QRect(widgetwidth*3/4 - 100, widgetheight/2 - 320, 200, 400)
        text.drawText(temp, Qt.AlignCenter, 'Pre-school Location \n\n\nSimulate Choice Sets \nWithin 20 mins \nTravel from either \nWork or Residence')
